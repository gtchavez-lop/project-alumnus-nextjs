		...
		<>
			<motion.main
				...
				<div className="flex flex-col gap-20">
						...
						<ul className="  ml-10 flex list-disc flex-col gap-2">
							...
							<li>
								<p>
									...
									this Agreement) refers to BSCS3A - Team Alumnus - University of
									Caloocan City, Congressional Rd Ext, Barangay 171, Caloocan, Metro
									Manila.
								</p>
							</li>
							<li>
					...
					<div className="flex flex-col gap-5">
						<h1 className="mb-3 text-3xl">Collecting and Using Your Personal Data</h1>
