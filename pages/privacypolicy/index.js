...
const PrivacyStatement = (e) => {
  ...
  return (
    <>
      <GradientTopBar colorLeft="#EA580C" colorRight={'#1E40AF'} />
      <motion.main
      ...
      >
        <div className="flex flex-col gap-20">
          ...
          <div className="flex flex-col gap-5">
            <p className="opacity-50">Last updated: May 03, 2022</p>
            <p>
          ...
          <div className="flex flex-col gap-5">
            <h1 className="mb-3 text-3xl">Interpretation and Definitions</h1>
            ...
            <ul className="  ml-10 flex list-disc flex-col gap-2">
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to BSCS3A - Team
                  Alumnus - University of Caloocan City, Congressional Rd Ext,
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to UCC Project Alumnus,
                  accessible from{' '}
          ...
          <div className="flex flex-col gap-5">
            ...
            <h3 className="mt-3 text-xl">Tracking Technologies and Cookies</h3>
            <p>
          ...
          <div className="flex flex-col gap-5">
            <h1 className="mb-3 text-3xl">Links to Other Websites</h1>
            <p>
          ...
          <div className="flex flex-col gap-5">
            <h1 className="mb-3 text-3xl">Changes to this Privacy Policy</h1>
            <p>
          ...
          {/* contact us */}
          <div className="flex flex-col gap-5">
            <h1 className="mb-3 text-3xl">Contact Us</h1>
            <p>
            ...
            <ul className="ml-10 flex list-disc flex-col gap-2">
              <li>
                <strong>By email:</strong> projectalumnus@gmail.com
              </li>
            </ul>
          </div>
        </div>
