          ...
          {_pageCount === 3 && (
            ...
            >
              ...
              <p className="text-lg mt-2">
                We provided you some information that was found in your Student
                ID
              </p>
              <label className="form-control mt-5 gap-8">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    onChange={(e) => {
                      _setUserDetails({
                        ..._userDetails,
                        birthdate: dayjs(e.target.value).format('YYYY-MM-DD'),
                      });
                    }}
                ...
                <div className="flex flex-col">
                  ...
                  />
                  <span>
                    Please start with the acronym of the degree title(i.e. BS
                    Computer Science, BS Psychology)
                  </span>
                </div>
                <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                  ...
                  />
                  <span>
                    Are you currently working? If yes, 2 more input fields will
                    show below
                  </span>
                </div>
          ...
          {_pageCount === 4 && (
            ...
            >
              ...
              <div className="flex flex-col bg-base-200 p-4 rounded-xl">
                <span>Program Starting Date</span>
                <span className="text-sm text-accent font-bold">
                  {dayjs(_userDetails.programStartDate).format('MMMM DD, YYYY')}
                </span>
              </div>
              <div className="flex flex-col bg-base-200 p-4 rounded-xl">
                <span>Graduation Date</span>
                <span className="text-sm text-accent font-bold">
                  {dayjs(_userDetails.graduationDate).format('MMMM DD, YYYY')}
                </span>
              </div>
              <div className="flex flex-col bg-base-200 p-4 rounded-xl">
                <span>Occupation Status</span>
