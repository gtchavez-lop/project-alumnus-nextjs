				...
				<div className="flex flex-col gap-20">
					...
					<div className="flex flex-col gap-5">
						...
						<p>
							...
							conditions. Do not continue to use UCC Project Alumnus if you do not
					...
					<div className="flex flex-col gap-5">
						...
						<p>
							...
							intellectual property rights for all material on UCC Project Alumnus. All
							intellectual property rights are reserved. You may access this from UCC
							Project Alumnus for your own personal use subjected to restrictions set
						...
						<ul className="  ml-10 flex list-disc flex-col gap-2">
							...
							<li>Sell, rent or sub-license material from UCC Project Alumnus</li>
							<li>Reproduce, duplicate or copy material from UCC Project Alumnus</li>
						...
						<p>
							...
							opinions and information in certain areas of the website. BSCS3A - Team
							Alumnus - University of Caloocan City does not filter, edit, publish or
							review Comments prior to their presence on the website. Comments do not
							reflect the views and opinions of Team Alumnus,its agents and/or
							...
							laws, Team Alumnus shall not be liable for the Comments or for any
						...
						<p>
							Team Alumnus reserves the right to monitor all Comments and to remove any
						...
						<p>
							You hereby grant Team Alumnus a non-exclusive license to use, reproduce,
					...
					<div className="flex flex-col gap-5">
						...
						<p>
							...
							hyperlink compensates the absence of Team Alumnus; and (d) the link is in
						...
						<p>
							...
							e-mail to Team Alumnus. Please include your name, your organization name,
					...
					<div className="flex flex-col gap-5">
						...
						<p>
							...
							are provided free of charge, we will not be liable for any loss or damage
							of any nature.
						</p>
					</div>
				</div>
