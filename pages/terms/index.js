...
const Terms = () => {
  ...
  return (
    <>
      <GradientTopBar colorLeft="#1E40AF" colorRight={'#EA580C'} />
      <motion.main
        ...
        <div className="flex flex-col gap-20">
          ...
          <div className="flex flex-col gap-5">
            <p className="text-xl font-semibold">
              Welcome to UCC Project Alumnus!
            </p>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of Team Alumnus&#39;s Website, located at
              https://ucc-alumnus.vercel.app.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use UCC Project Alumnus if you do
            ...
            <p>
              ...
              accordance with and subject to, prevailing law of the Republic of
              the Philippines. Any use of the above terminology or other words
          ...
          <div className="flex flex-col gap-5">
            ...
            <p>
              We employ the use of cookies. By accessing UCC Project Alumnus,
              you agreed to use cookies in agreement with the Team Alumnus&#39;
              Privacy Policy.
            </p>
            <p>
          ...
          <div className="flex flex-col gap-5">
            ...
            <p>
              Unless otherwise stated, Team Alumnus and/or its licensors own the
              intellectual property rights for all material on UCC Project
              Alumnus. All intellectual property rights are reserved. You may
              access this from UCC Project Alumnus for your own personal use
              subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul className="  ml-10 flex list-disc flex-col gap-2">
              <li>Republish material from UCC Project Alumnus</li>
              <li>
                Sell, rent or sub-license material from UCC Project Alumnus
              </li>
              <li>
                Reproduce, duplicate or copy material from UCC Project Alumnus
              </li>
              <li>Redistribute content from UCC Project Alumnus</li>
            </ul>
            ...
            <p>
              ...
              BSCS3A - Team Alumnus - University of Caloocan City does not
              ...
              Team Alumnus,its agents and/or affiliates. Comments reflect the
              views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, Team Alumnus
            ...
            <p>
              Team Alumnus reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Team Alumnus a non-exclusive license to use,
          ...
          <div className="flex flex-col gap-5">
            ...
            <p>
              ...
              Team Alumnus; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to Team Alumnus. Please include your name,
            ...
            <p>
              No use of Team Alumnus&#39; logo or other artwork will be allowed
